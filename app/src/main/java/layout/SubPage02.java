...
public class SubPage02 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View mLinearLayout = (LinearLayout) inflater.inflate(R.layout.fragment_sub_page02, container, false);
...
// Naturally, this can be any View; it doesn't have to be a button
        Button myButton = (Button) mLinearLayout.findViewById(R.id.button);
